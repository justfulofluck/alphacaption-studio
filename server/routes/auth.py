...
def logout():
    # Since we use stateless JWT, logout is primarily handled on the frontend 
    # by deleting the token. We return success to the frontend.
...
def get_vertex_token():
    ...
    try:
        # Fallback 1: Use temporary token if provided in .env
        ...
        # Fallback 2: Try Application Default Credentials
