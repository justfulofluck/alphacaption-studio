...
function createStackedPlanesBufferGeometry(
  ...
  const xOffsetBase = -totalWidth / 2 + offsetX;
...
export default function Beams({
  ...
  useEffect(() => {
    ...
    const geometry = createStackedPlanesBufferGeometry(beamNumber, beamWidth, beamHeight, 0, 100, offsetX);
  ...
  }, [beamWidth, beamHeight, beamNumber, lightColor, speed, noiseIntensity, scale, rotation, offsetX]);

  return (
    <div ref={containerRef} className={`beams-container w-full h-full relative ${className}`} />
  );
}
